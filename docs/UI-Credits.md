...
- **Dashboard-Komorebi.css** by **InlitX**
  Komorebi (木漏れ日) visual style for Obsidian dashboards.
...
Original design and authorship belong to their respective creators. The original files' copyright and license status remain as stated by the original authors.

This credit is also included in:
- styles.css (header comment)
- README.md (致谢 section)